...
public class RsaUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Encrypted username：" + RsaUtil.encryptByPublicKey(publicKey, "<username>"));
        System.out.println("Encrypted password：" + RsaUtil.encryptByPublicKey(publicKey, "<password>"));
    }
